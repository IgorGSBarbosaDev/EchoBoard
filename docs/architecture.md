...
- Audio mixer peak meters are captured in the audio layer without UI or persistence access and exposed as effects, monitor, and virtual-output levels on `AudioRoutingSnapshot`; Dashboard and Diagnostics bind to those shared values.
